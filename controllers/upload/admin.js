...
module.exports = {
  async find(ctx) {
    ...
    const files = await siapi.plugins.upload.services.upload[method](query, []);
  ...
  async count(ctx) {
    ...
    const count = await siapi.plugins.upload.services.upload[method](query);
...
const findEntityAndCheckPermissions = async (ability, action, model, id) => {
  ...
  const author = await siapi.admin.services.user.findOne({ id: file[CREATED_BY_ATTRIBUTE] }, [
    'roles',
  ]);
